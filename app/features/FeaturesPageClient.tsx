              ...
              <Card key={index} className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow group">
                ...
                <div className="p-6">
                  ...
                  <Button asChild className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white">
                    <Link href={feature.path}>{feature.buttonText}</Link>
                  </Button>
                </div>
              </Card>
            ))}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Import your existing resume or create a new one using our builder</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Our AI analyzes requirements and matches them to your experience</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Download perfectly tailored cover letters and resumes ready to submit</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex">
                <div className="mr-6"><div className="bg-orange-700 p-4 rounded-lg"><Sparkles className="h-8 w-8 text-orange-300" /></div></div>
                <div>
                  <h3 className="text-xl font-bold mb-2">Keyword Optimization</h3>
                  <p className="text-orange-100">Our AI identifies key skills and requirements from job descriptions and seamlessly incorporates them into your cover letters and resumes.</p>
                </div>
              </div>
              <div className="flex">
                <div className="mr-6"><div className="bg-orange-700 p-4 rounded-lg"><ScanSearch className="h-8 w-8 text-orange-300" /></div></div>
                <div>
                  <h3 className="text-xl font-bold mb-2">ATS Compatibility Analysis</h3>
                  <p className="text-orange-100">Get detailed feedback on how well your resume will perform with applicant tracking systems and suggestions for improvements.</p>
                </div>
              </div>
              <div className="flex">
                <div className="mr-6"><div className="bg-orange-700 p-4 rounded-lg"><MessagesSquare className="h-8 w-8 text-orange-300" /></div></div>
                <div>
                  <h3 className="text-xl font-bold mb-2">Interview Question Prediction</h3>
                  <p className="text-orange-100">Our system analyzes job descriptions to predict likely interview questions and helps you prepare compelling answers.</p>
                </div>
              </div>
              <div className="flex">
                <div className="mr-6"><div className="bg-orange-700 p-4 rounded-lg"><MailCheck className="h-8 w-8 text-orange-300" /></div></div>
                <div>
                  <h3 className="text-xl font-bold mb-2">Follow-Up Email Generation</h3>
                  <p className="text-orange-100">Create professional follow-up emails at the perfect time to increase your chances of getting a response.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              <Button asChild size="lg" className="bg-white text-orange-700 hover:bg-orange-50">
                <Link href="#features">Explore All Features<ArrowRight className="ml-2 h-5 w-5" /></Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-br from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auth/register">
                <Button size="lg" className="bg-white text-orange-700 hover:bg-orange-50">Get Started - It&apos;s Free</Button>
              </Link>
              <Link href="/pricing">
                <Button size="lg" className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white">View Pricing</Button>
              </Link>
            </div>
          </div>
        </div>
