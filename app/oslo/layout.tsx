    ...
    <AuthGuard>
      <div className="min-h-screen flex flex-col bg-gray-50">
              ...
              <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
                ...
                <SheetContent side="left" className="p-0 w-[250px] bg-white">
                  <div className="flex h-full flex-col">
                    <div className="flex items-center justify-between h-16 border-b px-4 bg-orange-700">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => setIsMobileOpen(false)} className="text-white hover:text-orange-200">
                        <X className="h-5 w-5" />
                      </Button>
                    </div>
        ...
        <div className="flex-1 flex">
          ...
          >
            <div className={cn(
              "flex h-16 items-center border-b px-4 bg-orange-700",
              ...
              <Button 
                ...
                className={cn("p-0 h-8 w-8 text-white hover:text-orange-200 hover:bg-orange-600", isCollapsed ? "ml-0" : "ml-2")}
              >
                {isCollapsed ? (
