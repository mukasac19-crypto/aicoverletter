    ...
    <div className="w-full h-full bg-white p-4 sm:p-6 md:p-10">
      <header className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">Cover Letters</h1>
            <p className="text-sm text-muted-foreground">
          ...
          {coverLetterUsage && (
            <FeatureUsageIndicator
              ...
              unlimited={coverLetterUsage.unlimited}
              variant="compact"
              className="mr-4"
            />
          )}
      ...
      >
        <TabsList className="mb-6 w-full flex flex-nowrap bg-muted/50 rounded-lg p-1 gap-2">
          ...
          >
            ...
            <div className="hidden md:block">Follow-Up</div>
          </TabsTrigger>
        </TabsList>
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                    ...
                    >
                      <CollapsibleTrigger asChild>
                        <Button size="sm" className="bg-orange-600 hover:bg-orange-300 w-full sm:w-auto">
              ...
              <div className="space-y-6">
                        ...
                        >
                          <div className="flex flex-col sm:flex-row justify-between">
                            ...
                            <div className="mt-3 sm:mt-0">
                              <LimitedActionButton
                                feature="coverLetters"
                                featureName="Follow-Up Email"
                                confirmationMessage="Follow-up emails count towards your cover letter limit."
                                onAllowed={() => {
                                  // Create follow-up email logic here
                                }}
                                variant="outline"
                                size="sm"
                              >
                ...
                <div className="border-t pt-6">
                  ...
                  <LimitedActionButton
                    ...
                    confirmationMessage="Follow-up emails count towards your cover letter limit."
                    onAllowed={() => {
                      // Create stand-alone follow-up logic
                    }}
                  >
                    <FollowUpEmailGenerator
                      variant="modal"
