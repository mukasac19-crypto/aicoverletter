...
import { FileText, Upload, ArrowRight, CheckCircle, Sparkles, Star, Zap, Shield, Clock, Users, ChevronDown } from "lucide-react"
  ...
  return (
    <main className="min-h-screen bg-teal-50/20">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="bg-gradient-to-r from-orange-600 to-orange-600 bg-clip-text text-transparent">
                AI-Powered Cover Letters, Resumes & ATS Tools
              </span>
            </h1>

            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              From job hunting, resume and cover letter creation, to interview prep and follow-up emails — everything you need in one AI assistant. Join 100,000+ professionals who&apos;ve landed jobs at top companies.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block rounded-full bg-orange-100 px-4 py-2 text-sm font-semibold text-orange-800 mb-4">HOW IT WORKS</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow">
                ...
                <div className="absolute -top-4 -right-4 bg-orange-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">1</div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">Auto-extracts key requirements</span></li>
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">Identifies important keywords</span></li>
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">Understands company culture</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow">
                ...
                <div className="absolute -top-4 -right-4 bg-orange-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">2</div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">LinkedIn one-click import</span></li>
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">PDF/Word resume upload</span></li>
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">Smart experience matching</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow">
                ...
                <div className="absolute -top-4 -right-4 bg-purple-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">3</div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-purple-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">ATS-optimized formatting</span></li>
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-purple-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">Multiple export formats</span></li>
                  <li className="flex items-start"><CheckCircle className="h-5 w-5 text-purple-500 mr-2 flex-shrink-0" /><span className="text-sm text-gray-700">Real-time editing</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block rounded-full bg-yellow-100 px-4 py-2 text-sm font-semibold text-yellow-800 mb-4">SUCCESS STORIES</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 border-0 shadow-lg bg-gradient-to-br from-white to-gray-50">
              ...
              <p className="text-gray-700 mb-4 italic">
                &ldquo;Landed my dream job at Google within 2 weeks of using CareerThings AI. The ATS optimization was a game-changer!&rdquo;
              </p>
            ...
            <Card className="p-6 border-0 shadow-lg bg-gradient-to-br from-white to-gray-50">
              ...
              <p className="text-gray-700 mb-4 italic">
                &ldquo;The AI understood exactly what Tesla was looking for. My tailored resume got me an interview on the first try!&rdquo;
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center text-white font-bold">M</div>
                <div>
            ...
            <Card className="p-6 border-0 shadow-lg bg-gradient-to-br from-white to-gray-50">
              ...
              <p className="text-gray-700 mb-4 italic">
                &ldquo;From 50+ rejections to 5 interviews in a month. This tool completely transformed my job search strategy!&rdquo;
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-600 rounded-full flex items-center justify-center text-white font-bold">A</div>
                <div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block rounded-full bg-gradient-to-r from-orange-100 to-orange-100 px-4 py-2 text-sm font-semibold text-orange-800 mb-4">SIMPLE PRICING</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {Object.entries(SUBSCRIPTION_PLANS).map(([tier, plan]) => (
              <div key={tier} className={`relative ${tier === "PRO" ? "md:-mt-4" : ""}`}>
                {tier === "PRO" && (
                ...
                <Card className={`h-full ${tier === "PRO" ? "border-2 border-orange-500 shadow-2xl scale-105" : "border border-gray-200 shadow-lg"} hover:shadow-xl transition-all duration-300 bg-white rounded-2xl overflow-hidden`}>
                  <div className={`p-8 ${tier === "FREE" ? "bg-gradient-to-br from-gray-50 to-white" : tier === "PRO" ? "bg-gradient-to-br from-orange-50 to-white" : "bg-gradient-to-br from-purple-50 to-white"}`}>
                    <div className="mb-4">
                    ...
                    <div className="mb-6">
                      <div className="flex items-baseline">
                        ...
                        {plan.price.monthly > 0 && <span className="text-gray-500 ml-2">/month</span>}
                      </div>
                      {tier === "PRO" && <p className="text-sm text-orange-600 mt-2">Save 20% with annual billing</p>}
                    </div>
                    <ul className="space-y-3 mb-8">
                      {plan.features.slice(0, 6).map((feature, idx) => (
                        <li key={idx} className="flex items-start">
                          <CheckCircle className={`h-5 w-5 mr-3 mt-0.5 flex-shrink-0 ${tier === "FREE" ? "text-gray-400" : tier === "PRO" ? "text-orange-500" : "text-purple-500"}`} />
                          <span className="text-sm text-gray-700">{feature}</span>
                        </li>
                      ))}
                    </ul>
                    <Link href="/auth/register" className="block">
                      <Button className={`w-full py-6 text-base font-semibold ${tier === "FREE" ? "bg-gray-900 hover:bg-gray-800" : tier === "PRO" ? "bg-gradient-to-r from-orange-600 to-orange-600 hover:from-orange-700 hover:to-orange-700 shadow-lg shadow-orange-500/25" : "bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"}`}>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 mb-4">All plans include: Unlimited downloads • 24/7 support • SSL encryption</p>
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-12">
            <span className="inline-block rounded-full bg-blue-100 px-4 py-2 text-sm font-semibold text-blue-800 mb-4">FAQ</span>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Frequently Asked Questions</h2>
          </div>

          <div className="space-y-4">
            {homeFaqs.map((faq, index) => (
              <Card key={index} className={`border transition-all duration-300 ${openFAQIndex === index ? 'border-orange-400 shadow-lg' : 'border-gray-200 hover:border-orange-300'}`}>
                <button
                ...
                >
                  ...
                  <div className={`flex-shrink-0 transition-transform duration-300 ${openFAQIndex === index ? 'rotate-180' : ''}`}>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-600 via-orange-600 to-orange-700 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to 10x Your Job Search Success?</h2>
            ...
            <div className="flex items-center justify-center gap-6 text-sm">
              <div className="flex items-center gap-2"><Shield className="h-5 w-5" /><span>No credit card required</span></div>
              <div className="flex items-center gap-2"><Clock className="h-5 w-5" /><span>Setup in 30 seconds</span></div>
              <div className="flex items-center gap-2"><Users className="h-5 w-5" /><span>Join 100,000+ users</span></div>
            </div>
          </div>
        </div>
      </section>
