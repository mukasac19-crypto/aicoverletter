...
export async function GET(
  ...
  try {
    ...
    if (error) {
      console.error(`Error fetching resume template ${templateId}:`, error);
...
export async function PUT(
  ...
  try {
    ...
    if (error) {
      console.error(`Error updating resume template ${templateId}:`, error);
      throw error;
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      console.error(`Error deleting resume template ${templateId}:`, error);
      throw error;
    }
