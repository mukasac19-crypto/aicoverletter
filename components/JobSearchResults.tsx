//C:\Users\mukas\Downloads\project-bolt-sb1-guerg2d9\project\components\JobSearchResults.tsx
        ...
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm text-muted-foreground mt-2 text-center max-w-md">
              We couldn't find any jobs matching your search. Try broadening your search terms or reducing filters.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              ...
              <span>{sortBy === "relevance" ? "Most Relevant" : sortBy === "date" ? "Newest First" : "Best Match"}</span>
            </Button>
          </div>
        </div>
      </div>
