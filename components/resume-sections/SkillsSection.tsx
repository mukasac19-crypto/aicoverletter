  ...
  const generateSkillsWithAI = async () => {
    try {
      ...
      if (result.skills && Array.isArray(result.skills)) {
        ...
        const existingSkillNames = new Set(data.map(skill => skill.name.toLowerCase()));
      ...
      toast({
        ...
        description: err.message || "Failed to generate skills. Please try again.",
        variant: "destructive",
      });
    } finally {
          ...
          <CardContent className="flex flex-col items-center justify-center py-10">
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Add your skills to highlight your expertise and increase your resume's impact.
              </p>
              <Button 
                variant="outline" 
                onClick={generateSkillsWithAI}
  ...
  return (
    ...
    >
      ...
      <Alert className="bg-muted">
        ...
        <AlertDescription>
          Pro tip: Group your skills by category and include proficiency levels for better organization.
        </AlertDescription>
      </Alert>
    </div>
  );
